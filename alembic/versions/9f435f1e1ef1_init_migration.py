...
Revision ID: 9f435f1e1ef1
Revises: 
Create Date: 2023-05-27 12:08:01.414351
...
def upgrade() -> None:
    ...
    sa.Column('amount', sa.Integer(), nullable=False, comment='Кол-во грамм продукта'),
    ...
    op.create_table('item_category_associations',
    sa.Column('item_id', sa.Integer(), nullable=False),
    sa.Column('category_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['category_id'], ['categories.id'], name=op.f('fk_item_category_associations_category_id_categories')),
    sa.ForeignKeyConstraint(['item_id'], ['items.id'], name=op.f('fk_item_category_associations_item_id_items')),
    sa.PrimaryKeyConstraint('item_id', 'category_id', name=op.f('pk_item_category_associations'))
    )
...
def downgrade() -> None:
    ...
    op.drop_table('item_category_associations')
